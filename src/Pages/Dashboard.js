            ...
            <div className="main-content">
                ...
                <div className="data-visualizations">
                    <div className="data-card">
                        ...
                        <div className="bar-graph-container">  {/* Add a container for the bar graph*/}
                            <BarGraph />
                        </div>
                    </div>
                    <div className="data-card">
                        <h3 className="data-card-h3">Publications Trend</h3>
                        <div className="line2-container">  {/* Add a container for the bar graph*/}
                            <Line2 />
                        </div>
                    </div>
                    {/* <div className="data-card">
                        <h3 className="data-card-h3">Student Demographics</h3>
